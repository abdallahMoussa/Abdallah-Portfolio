  ...
  return (
    <div className={`${style.about} w-full text-left`}>
      <div className={`${style.section}`}>
        ...
        <pre className={`${style.disc} ${style.discWho}`}>
          {" "}
          Innovative Front-End developer with 2 years’ experience in web
          development, loving coding and challenges. I have a big passion to
          learn new technologies, I have a good experience in HTML, CSS, JS,
          modern libraries and frameworks like React Js and Next Js. I looking
          forward to have my own technology that compete with current modern
          technology.
        </pre>
      </div>
      <div className={`${style.section}`}>
        ...
        <pre className={`${style.disc} ${style.eduDisc}`}>
      ...
      <div className={style.colection}>
        <div className={`${style.section}`}>
          ...
          <pre className={`${style.disc} ${style.langDisc}`}>
            Arabic <sub>"native"</sub>
            <br />
            English <sub>"good"</sub>
          </pre>
        </div>
        ...
        <div className={`${style.section}`}>
          ...
          <pre className={`${style.disc} ${style.militaryDisc}`}>
            Completed <sub>"Good Idol"</sub>
          </pre>
        </div>
      </div>
    </div>
